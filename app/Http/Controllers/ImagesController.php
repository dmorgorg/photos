...
class ImagesController extends Controller
{
    ...
    */
    ...
    {
        // don't set the authentication middleware since guests should have access to the index page
    ...
    */
    ...
    public function postCreate(Request $request){
        ...
        $this->validate($request, [
            'file_input'     => 'required|image|mimes:jpeg,png|min:1|max:2500',
        ...
        $img->heighten(150)->save('images/150/'.$filename);
        $img->heighten(100)->save('images/100/'.$filename);
        $img->heighten(75)->save('images/075/'.$filename);
